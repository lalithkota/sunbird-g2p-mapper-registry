...
func init() {
            ...
            "schema": {
              ...
              "properties": {
                "header": {
                  "allOf": [
                    {
                      "$ref": "#/definitions/MsgCallbackHeader"
                    }
                  ]
                },
                "message": {
              ...
              "properties": {
                ...
                "message": {
                  ...
                  "properties": {
                    ...
                    "txnstatus_response": {
                      "$ref": "#/definitions/TxnStatusResponse"
                    }
                  }
                },
                "signature": {
  ...
  "definitions": {
    ...
    "PostG2pFamapOnSearchDefaultBodyMessage": {
      "type": "object",
      "properties": {
        "ack_status": {
          "$ref": "#/definitions/Ack"
    ...
    "PostG2pFamapOnSearchForbiddenBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
    ...
    "PostG2pFamapOnSearchInternalServerErrorBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
    ...
    "PostG2pFamapOnSearchParamsBodyMessage": {
      "type": "object",
      "required": [
        "transaction_id",
        "search_response"
    ...
    "PostG2pFamapOnSearchUnauthorizedBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
    ...
    "PostG2pMapperOnLinkDefaultBodyMessage": {
      "type": "object",
      "properties": {
        "ack_status": {
          "$ref": "#/definitions/Ack"
    ...
    "PostG2pMapperOnLinkForbiddenBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
    ...
    "PostG2pMapperOnLinkInternalServerErrorBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
    ...
    "PostG2pMapperOnLinkParamsBodyMessage": {
      "type": "object",
      "required": [
        "transaction_id",
        "link_response"
    ...
    "PostG2pMapperOnLinkUnauthorizedBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
    ...
    "PostG2pMapperOnResolveDefaultBodyMessage": {
      "type": "object",
      "properties": {
        "ack_status": {
          "$ref": "#/definitions/Ack"
    ...
    "PostG2pMapperOnResolveForbiddenBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
    ...
    "PostG2pMapperOnResolveInternalServerErrorBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
    ...
    "PostG2pMapperOnResolveParamsBodyMessage": {
      "type": "object",
      "required": [
        "transaction_id",
        "resolve_response"
    ...
    "PostG2pMapperOnResolveUnauthorizedBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
    ...
    "PostG2pMapperOnTxnstatusDefaultBodyMessage": {
      "type": "object",
      "properties": {
        "ack_status": {
          "$ref": "#/definitions/Ack"
    ...
    "PostG2pMapperOnTxnstatusForbiddenBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
    ...
    "PostG2pMapperOnTxnstatusInternalServerErrorBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
    ...
    "PostG2pMapperOnTxnstatusParamsBodyMessage": {
      "type": "object",
      "required": [
        "transaction_id",
        "txnstatus_response"
    ...
    "PostG2pMapperOnTxnstatusUnauthorizedBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
    ...
    "PostG2pMapperOnUnlinkDefaultBodyMessage": {
      "type": "object",
      "properties": {
        "ack_status": {
          "$ref": "#/definitions/Ack"
    ...
    "PostG2pMapperOnUnlinkForbiddenBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
    ...
    "PostG2pMapperOnUnlinkInternalServerErrorBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
    ...
    "PostG2pMapperOnUnlinkParamsBodyMessage": {
      "type": "object",
      "required": [
        "transaction_id",
        "unlink_response"
    ...
    "PostG2pMapperOnUnlinkUnauthorizedBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
    ...
    "PutG2pMapperOnUpdateDefaultBodyMessage": {
      "type": "object",
      "properties": {
        "ack_status": {
          "$ref": "#/definitions/Ack"
    ...
    "PutG2pMapperOnUpdateForbiddenBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
    ...
    "PutG2pMapperOnUpdateInternalServerErrorBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
    ...
    "PutG2pMapperOnUpdateParamsBodyMessage": {
      "type": "object",
      "required": [
        "transaction_id",
        "update_response"
    ...
    "PutG2pMapperOnUpdateUnauthorizedBodyError": {
      "type": "object",
      "properties": {
        "code": {
          "description": "error code",
