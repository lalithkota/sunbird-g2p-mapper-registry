...
// LinkResponse Beneficiary ID to Store of value account linking response
//
...
type LinkResponse struct {
	...
	// status reason code
	StatusReasonCode LinkStatusReasonCode `json:"status_reason_code,omitempty"`
...
func (m *LinkResponse) validateAdditionalInfo(formats strfmt.Registry) error {
...
func (m *LinkResponse) validateFa(formats strfmt.Registry) error {
...
func (m *LinkResponse) validateLocale(formats strfmt.Registry) error {
...
func (m *LinkResponse) validateReferenceID(formats strfmt.Registry) error {
...
func (m *LinkResponse) validateStatus(formats strfmt.Registry) error {
...
func (m *LinkResponse) validateStatusReasonCode(formats strfmt.Registry) error {
...
func (m *LinkResponse) validateStatusReasonMessage(formats strfmt.Registry) error {
...
func (m *LinkResponse) validateTimestamp(formats strfmt.Registry) error {
...
// ContextValidate validate this link response based on the context it is used
...
func (m *LinkResponse) contextValidateAdditionalInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LinkResponse) contextValidateFa(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LinkResponse) contextValidateLocale(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LinkResponse) contextValidateReferenceID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LinkResponse) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LinkResponse) contextValidateStatusReasonCode(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LinkResponse) contextValidateTimestamp(ctx context.Context, formats strfmt.Registry) error {
